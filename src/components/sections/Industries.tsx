...
import { Check, Building2, HeartPulse, ShoppingBag, GraduationCap, Factory, Truck, Home, Rocket } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {industries.map((it) => {
            ...
            return (
              ...
              >
                <div className="absolute -top-10 -right-10 h-40 w-40 rounded-full bg-primary/10 pointer-events-none" />
